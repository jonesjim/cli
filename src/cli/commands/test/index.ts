...
const appVulnsReleaseWarningMsg = `Important: Beginning January 24th, 2023, application dependencies in container
...
export default async function test(
  ...
  if (options.docker) {
    ...
    if (!options['app-vulns'] && !options['json']) {
      console.log(chalk.yellow(appVulnsReleaseWarningMsg));
    }
  }
